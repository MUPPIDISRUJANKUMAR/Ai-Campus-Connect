      ...
      try {
        ...
        querySnapshot.forEach((doc) => {
          ...
          firestoreAlumni.push({
            ...(data as User),
            id: doc.id,
            matchScore: (data.matchScore as number) || 0, // Provide default if missing
            connections: (data.connections as number) || 0, // Provide default if missing
            source: "firestore",
            role: (data.role as UserRole) || "alumni", // Provide default if missing
          });
        });
        ...
        const combinedAlumni = initialAlumni.map((staticAlumni) => {
