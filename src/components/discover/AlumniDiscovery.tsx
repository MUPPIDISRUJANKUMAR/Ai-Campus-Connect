...
export const AlumniDiscovery: React.FC = () => {
  ...
  const mockAlumni: (User & { matchScore: number; connections: number })[] = [
    {
      id: '2',
  ...
  const industries = ['all', 'Technology', 'Design', 'Consulting', 'Finance', 'Healthcare']
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold mb-2">Discover Alumni</h1>
        <p className="text-muted-foreground">
          Connect with alumni based on AI-powered recommendations and shared interests.
        </p>
      </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-sm font-medium">{alumni.matchScore}%</span>
                  </div>
                </div>
